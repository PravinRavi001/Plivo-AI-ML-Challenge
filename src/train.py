...
def parse_args():
    ...
    ap.add_argument("--model_name", default="microsoft/xtremedistil-l6-h384-uncased")
    ap.add_argument("--train", default="data/train_gen.jsonl")
    ap.add_argument("--dev", default="data/dev_gen.jsonl")
